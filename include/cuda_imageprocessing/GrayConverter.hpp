...
public:
    ...
    bool m_Run(const sensor_msgs::Image &srcMsg, sensor_msgs::Image &dstMsg) {
...

        {
            ...
            if (!m_CudaAllocation(&srcImage, &dstImage))
                return false;
            ...
            if (!m_Processing(&srcImage, &dstImage))
                return false;
